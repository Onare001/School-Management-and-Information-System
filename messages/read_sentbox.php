...
$inbox = "SELECT * FROM messages WHERE sch_id = '$sch_id' AND sender = '$user_id' AND message_id = '$mid'";
					...
					<div class="col-md-9">
						<div class="card card-primary card-outline">
							<div class="card-header">
								<h3 class="card-title">Read Mail (Sentbox)</h3>
							...
							<div class="card-body p-0">
								<div class="mailbox-read-info">
									...
									<h6>To: <?php echo getUsername($receiver);?><p>
									Name: <?php echo getLastname($receiver).'&nbsp;'.getFirstname($receiver);?>
