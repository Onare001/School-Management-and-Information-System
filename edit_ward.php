...
if (isset($_POST['submit'])) {
	...
	$type_id = addslashes($_POST["type_id"]);
$result = mysqli_query($conn,"UPDATE `stdnt_info` SET  `rel_id`='$rel_id',`sex_id`='$sex_id',`dob`='$dob',`state_id`='$state_id',`lga`='$lga',`type_id`='$type_id',`admn_no`= '$admn_no',`address`='$address',`p_name`='$p_name',`relationship`='$relation',`parent_contact`='$parent_contact',`bld_grp`='$bld_id',`gtype`='$geno_id',`house_id`='$house_id',`club_id`='$club_id' WHERE `stdnt_info`.`user_id` = '$uid'");//`class_id`='$class_id',`cat_id` = '$cat_id',
