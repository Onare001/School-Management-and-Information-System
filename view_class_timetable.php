<?php $page_title = "View Class Timetable"; ?>
...
if (isset($_POST['submit'])) {
    ...
    if (empty($class_id)) {
        ...
        header("location: class_timetable?cid=".encrypt($class_id)."&cat=".encrypt($cat_id)."");
    }
}
?>
<!DOCTYPE html>
...
<?php include('include/page_title.php');?>
			...
			<div class="card card-primary" id="selectbox">
				<div class="card-header"><h3 class="card-title">Select Class & Category | View Class Timetable</h3></div>
