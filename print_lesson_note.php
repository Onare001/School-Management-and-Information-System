<?php $sch_id = ""; $theme = ""; $page_title = "My Lesson Note"; ?>
<?php include "include/connection.php"; ?>
<?php include ("functions/functions.php"); ?>
<?php //include ("include/lock_all.php"); ?>
<?php 
	if(isset($_GET['url'])){
		$url = ($_GET['url']); //base64_decode
				...
				<div class="col-md-12 card">					
					<table>
						<thead style="font-size:3vw;">
							<tr>
								<th class="text-center"><img src="images/<?php echo getSchLogo(1);?>" width="90px" height="90px" class="img-circle"/></th>
						...
						<tbody style="font-size:2vw;">
							<tr>    
								<td colspan="2" class="text-center" style="min-width:100px"> LESSON NOTE | <?php echo $topic;?></td>
							</tr>                      
							<tr>
								<td colspan="2">
