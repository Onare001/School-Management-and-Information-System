<?php $page_title = "Testimonial Data"; ?>
...
if (isset($_POST['submit1'])) {
    ...
    $cat_id = $_POST['cat_id'];
    if (empty($year_id)) {
        $msg = '<span class="badge bg-danger">'.'Select Year of Graduation!'.'</span>';
		echo '<audio controls'.$autoplay.'hidden>
				<source src="audio/msg_select_class.mp3" type="audio/mpeg">
			</audio>';
    } else if (empty($cat_id)) {
        $msg = '<span class="badge bg-danger">'.'Select Class Category!'.'</span>';
		echo '<audio controls'.$autoplay.'hidden>
        ...
        if (mysqli_num_rows($result) != 0) {
            ...
            header("location: view_testimonial_data?yid=" . encrypt($year_id) . "&did=" . encrypt($cat_id) ."");
        } else {
            $msg = '<span class="badge bg-danger">'.'No graduated students in this Year'.'</span>';
			echo '<audio controls'.$autoplay.'hidden>
    ...
    $year_id = $_POST['year_id'];
	if (empty($username)) {
		$msg = '<span class="badge bg-danger">'.'Enter Student ID!'.'</span>';
		echo '<audio controls'.$autoplay.'hidden>
        ...
        if (mysqli_num_rows($result) != 0) {
            ...
            $msg = '<span class="badge bg-danger">'.'No Testimonial Found for this Student'.'</span>';
			echo '<audio controls'.$autoplay.'hidden>
						...
						<div class="row">
							<div class="col-5 col-sm-3">
								<div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
									<a class="nav-link active" id="vert-tabs-home-tab" data-toggle="pill" href="#vert-tabs-home" role="tab" aria-controls="vert-tabs-home" aria-selected="true">Final Year Student (<?php echo getClass(3);?>)</a>
									<a class="nav-link" id="vert-tabs-profile-tab" data-toggle="pill" href="#vert-tabs-profile" role="tab" aria-controls="vert-tabs-profile" aria-selected="false">Graduated Student</a>
								</div>
							</div>
