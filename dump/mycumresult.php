<?php $page_title = "My Cumulative Result"; ?>
...
// Getting the individual student's record
	$showresult = mysqli_query($conn,"SELECT DISTINCT * FROM cum_result JOIN sch_users ON cum_result.user_id=sch_users.user_id AND cum_result.sch_id=sch_users.sch_id JOIN stdnt_info ON sch_users.user_id=stdnt_info.user_id WHERE sch_users.user_id='$user_id' AND sch_users.sch_id='$sch_id' AND cum_result.sch_id='$sch_id' AND stdnt_info.status_id!='0' AND cum_result.class_id='$cid' AND cum_result.cat_id='$did' AND cum_result.sid='$sid' LIMIT 1");
...
<!--===============================!PAGINATION P/N===============================-->
	<div id="div_pagination">
		...
		<a href="check_result" title="back" style="width:2px;" class="button">BACK</a>
	</div>
</html>