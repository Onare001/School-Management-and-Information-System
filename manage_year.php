								...
								<div class="card-body">
									...
									<table id="example1" class="table table-bordered table-striped" style="width:70%">
										...
										<tr> 
											...
											<td id="status-<?php echo $row['year_id']; ?>" style="text-decoration:none;color:#007bff;"><?php echo ($row["status"]=='1') ? 'Active' : 'Inactive';?></td>
											<td align="center" width="5px"><?php echo ($row['status']=='1') ? '<a href="deactivate.php?yid='.$row['year_id'].'">
											<img src="assets/img/tick.png" alt="active"></a>' : '<a href="activate.php?yid='.$row['year_id'].'"><img src="assets/img/drop.png" alt="active"></a>'; ?></td>
											<td align="center" width="5px">
												<div class="custom-control custom-switch">
													<input type="checkbox" class="custom-control-input" id="customSwitch<?php echo $row['year_id']; ?>" <?php echo ($row['status'] == '1') ? 'checked' : ''; ?> data-tid="<?php echo $row['year_id'] ?>" data-state="<?php echo ($row['status'] == '1') ? '1' : '0'; ?>" data-table="year_info">
													<label class="custom-control-label" for="customSwitch<?php echo $row['year_id']; ?>"></label>
												</div>
											</td>
										</tr>
			<?php } 
